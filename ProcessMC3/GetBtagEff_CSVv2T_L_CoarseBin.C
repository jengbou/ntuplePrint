...
void GetBtagEff_CSVv2T_L_CoarseBin() {
...
//     cout << "[FIT 4]: chi2/ndof = " << resfit4->Chi2()/(resfit4->Ndf()+1.) << endl;
    ...
    // CSVv2T eff QCD MC
    TF1 *fCSVv2T1 = new TF1("fCSVv2T_30to1000","0.000685174+3.8751*pow(10,-6)*x-2.4856*pow(10,-10)*pow(x,2)",30,1000);
    fCSVv2T1->SetLineColor(4);
    fCSVv2T1->Draw("same");

    lgd->AddEntry(fCSVv2T1,"QCD CSVv2T udsg jet (BTagWG)", "l");

    //gPad->SetLogx();
    // End CSVv2T eff QCD MC light jets


    // CSVv2T eff QCD MC c jets
    TF1 *fCSVv2Tc1 = new TF1("fCSVv2Tc_30to1000","0.0303739-3.3768*pow(10,-5)*x+1.54025*pow(10,-8)*pow(x,2)",30,1000);
    fCSVv2Tc1->SetLineColor(3);
    fCSVv2Tc1->Draw("same");

    lgd->AddEntry(fCSVv2Tc1,"QCD CSVv2T c jet (BTagWG)", "l");

    //gPad->SetLogx();
    // End CSVv2T eff QCD MC c jets



    // DeepCSVT eff ttbar MC
    TF1 *fDeepCSVT1 = new TF1("fDeepCSVT_20to200",
                              "0.00232-6.185*pow(10,-5)*x+9.284*pow(10,-7)*pow(x,2)-5.919*pow(10,-9)*pow(x,3)+1.745*pow(10,-11)*pow(x,4)-1.929*pow(10,-14)*pow(x,5)",20,200);
    fDeepCSVT1->SetLineColor(2);
    fDeepCSVT1->Draw("same");
    TF1 *fDeepCSVT2 = new TF1("fDeepCSVT_225to1000","0.0004939+4.853*pow(10,-6)*x+4.61*pow(10,-10)*pow(x,2)",200,1000);
    fDeepCSVT2->SetLineColor(2);
    fDeepCSVT2->Draw("same");

    lgd->AddEntry(fDeepCSVT2,"t#bar{t} DeepCSVT udsg jet (BTagWG)", "l");
...
//     lgdf->Draw();
    ...
    // coarse bin
    cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_500toInf.pdf");
    cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_500toInf.png");

//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_500toInf_all.pdf");
//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_500toInf_all.png");

//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_700toInf.pdf");
//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_700toInf.png");

//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_700toInf_all.pdf");
//     cvs->SaveAs("eff_btag_l_CSVv2T_vs_pt_analysis_20180126_v0_p20180302_UMD_BtagEff_r1_p20180302_700toInf_all.png");
