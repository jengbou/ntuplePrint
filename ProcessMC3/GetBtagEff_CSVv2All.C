...
//     Float_t etabins[7] = {-3.0,-2.0,-1.4442,0.0,1.4442,2.0,3.0};
    ...
    lgd->SetHeader("b jets (UMD kine. cuts)");
...
//     lgdf->Draw();
    ...
    // coarse binning
    cvs->SaveAs("eff_btag_b_CSVv2All_vs_pt_BtagEff_r1_p20180312_500toInf_fine.pdf");
    cvs->SaveAs("eff_btag_b_CSVv2All_vs_pt_BtagEff_r1_p20180312_500toInf_fine.png");
