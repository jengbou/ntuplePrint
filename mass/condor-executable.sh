...
echo "run: time cmsRun $FINAL_PARAMETER_SET  $DATA inputFiles_load=$INPUTFILES > $FINAL_LOG 2>&1"
cmsRun $FINAL_PARAMETER_SET $DATA inputFiles_load=$INPUTFILES  >> $FINAL_LOG 2>&1
exitcode=$?
